...
export async function parseSemanticStateDirectives(input: {
  ...
  const task = createObjectTask({
    ...
    instructions: [
      ...
      "Si el estado es awaiting_order_adjustment, interpreta cambios naturales de todos los productos, cantidades, configuraciones y notas. No asumas que el cliente debe elegir una opcion numerada.",
      "Si el cliente cancela todo el pedido durante awaiting_order_adjustment, usa replacementRejectAll.",
