...
- router conversacional en experimento temporal de operaciones semánticas ID-based para todo texto del cliente, con validación determinística y transaccional de negocio,
